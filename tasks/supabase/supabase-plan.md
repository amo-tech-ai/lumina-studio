...
> **J20 audit header (2026-07-20):** This long-form plan is **supporting documentation**. The authoritative tracker is [`STATUS.md`](./STATUS.md); the authoritative execution queue is [`todo`](./todo); the J20 audit is [`j20-supabase-audit.md`](./j20-supabase-audit.md). Numbers and task statuses below may be stale — trust the audit and Linear over this file. Specifically: migrations are **216/216 zero drift** (not 208); IPI-680, IPI-684, IPI-692, IPI-647, IPI-665 are all **Done**; IPI-682 stale blocker removed; plan self-score is **66/100**.
...
**Companion notes:** [`notes-1.md`](./notes-1.md) · [`notes-2.md`](./notes-2.md) · [`notes-3.md`](./notes-3.md) · [`notes-4.md`](./notes-4.md) · [`todo`](./todo) · [`STATUS.md`](./STATUS.md) · [`j17-plan.md`](./j17-plan.md) · [`july-17supa-test.md`](./july-17supa-test.md) · [`testing.md`](./testing.md) · [`links.md`](./links.md)  
