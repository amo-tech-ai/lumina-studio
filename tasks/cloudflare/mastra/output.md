...
**Status note (corrected 2026-07-12):** No shared-registry design or PR exists yet. `app/src/mastra/tools/index.ts` (20 tools, Zod-typed input/output schemas) is a solid, Mastra-only registry with zero cross-import or shared interface with `services/cloudflare-worker/`. Treat this issue as pre-design on the "shared" half — not in-progress toward a cross-surface merge — until a design doc/PR exists.

**Recommendation:** Move to **Todo** (deferred). This is "nice-to-have" behind tool calling. Don't let it block critical path. Revisit after [IPI-525](https://linear.app/amo100/issue/IPI-525/cf-ai-011-workers-ai-tool-calling-add-toolstool-choice-forwarding-to) + CF-MIG-220 complete.
...
* Every tool call is logged to Supabase `ai_agent_logs` | Todo |  | Urgent | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-07T21:56:05.712Z | 2026-07-12T06:11:51.118Z |  |  |  |  |  | 2026-07-08T21:56:06.215Z | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | Breached | fd802975-25d2-45f1-8b60-e97924528184 | 601 | IPI-490, IPI-10, IPI-473, IPI-472, IPI-471, IPI-470, IPI-468, IPI-467, IPI-466 |  |  |
| IPI-369 | iPix1 | CRM-AI-003 · crm-assistant agent — wave 2 (health scoring, summarization, drafting) + IntelligencePanel sections | ## Provider model (2026-07-09 · Mastra × Cloudflare audit)
...
* Target path: **Cloudflare AI Gateway** OpenAI-compat (`AI_GATEWAY_URL`) via [IPI-454](https://linear.app/amo100/issue/IPI-454/ipi-454-cf-ai-001-ai-gateway-cloudflare-provider-routing) AC-F — not direct `GEMINI_API_KEY` long-term.
* **Gemini** = vision + structured fallback only until Workers AI eval ([IPI-462](https://linear.app/amo100/issue/IPI-462/ipi-462-cf-ai-006-ai-provider-evaluation-suite)).
* **Workers AI** default flip blocked until [IPI-462](https://linear.app/amo100/issue/IPI-462/ipi-462-cf-ai-006-ai-provider-evaluation-suite) sign-off.
...
**Blocked by:** [IPI-368](https://linear.app/amo100/issue/IPI-368/crm-ai-002-crm-assistant-agent-wave-1-searchlogmove-tools) (hard) · **Blocker corrected 2026-07-10:** the board-dependency AC previously cited [IPI-365](https://linear.app/amo100/issue/IPI-365/crm-ux-003-pipeline-board-kanban-ungated-stage-moves-realtime), which is now status **Duplicate** — the Pipeline board actually shipped under [IPI-395](https://linear.app/amo100/issue/IPI-395/scr-30-crm-pipeline-react-parity) (SCR-30, **Done**, PR #275). Re-pointing this blocker to [IPI-395](https://linear.app/amo100/issue/IPI-395/scr-30-crm-pipeline-react-parity) — since [IPI-395](https://linear.app/amo100/issue/IPI-395/scr-30-crm-pipeline-react-parity) is Done, this leg of the dependency is resolved. · **Unblocks:** [IPI-370](https://linear.app/amo100/issue/IPI-370/crm-qa-001-mvp-acceptance-verification)
...
flowchart TD
  ...
  FOCUS --> PIPE["Pipeline at-risk filter — IPI-395, already shipped"]
```
...
- [ ] **A1** Confirm [IPI-368](https://linear.app/amo100/issue/IPI-368/crm-ai-002-crm-assistant-agent-wave-1-searchlogmove-tools) merged — proof: `crm-assistant` responds in dev on `/app/crm/*`
- [X] **A2** Pipeline board exists (shipped via [IPI-395](https://linear.app/amo100/issue/IPI-395/scr-30-crm-pipeline-react-parity), PR #275) — at-risk wiring can proceed
...
- [ ] **C1** Pipeline board's "at risk" filter wired to `scoreDealHealth(focus: at_risk)` — note: [IPI-395](https://linear.app/amo100/issue/IPI-395/scr-30-crm-pipeline-react-parity)'s shipped board (PR #275) is currently read-only with no drag/stage-change UI; confirm at-risk filter attaches to that read surface — proof: manual test
...
### Gantt — [IPI-369](https://linear.app/amo100/issue/IPI-369/crm-ai-003-crm-assistant-agent-wave-2-health-scoring-summarization)
...
``` | Todo |  | Urgent | 51b8b9e3-a396-4bcf-a531-ef8b1ea3dce7 | CRM — Relationship Layer | ai@socialmediaville.ca |  | AI, COPILOTKIT, CRM, GEMINI, MASTRA |  |  |  |  | 2026-07-04T07:01:38.298Z | 2026-07-12T15:17:32.954Z |  |  |  |  |  | 2026-07-13T14:39:09.491Z |  |  | 82d68607-87e5-4c4c-b0eb-1055e0e92c4c | CRM-M3 · crm-assistant Agent | HighRisk | 11f5d03b-dcf5-4d5b-aa01-4a83d5fdf978 | 11823 | IPI-454, IPI-462, IPI-365, IPI-568, IPI-374, IPI-563, IPI-379, IPI-378 |  |  |
| IPI-508 | iPix1 | IPI-508 · CF-UJ-008 — Journey test: Marketing/operator fast chat (gateway) | ## CF-UJ-008 — Journey test: Marketing & operator `fast` chat (gateway)

**Plan:** `tasks/cloudflare/user-journeys/08-marketing-operator-chat.md`
**Parent:** [IPI-500](https://linear.app/amo100/issue/IPI-500/ipi-cf-uj-000-real-world-ai-journey-test-suite) · CF-UJ-000
**Skills:** `mastra` · `copilotkit` · `cloudflare`

### When to test (gate) — FIRST product gateway proof

**Start as soon as:**

1. [IPI-454](https://linear.app/amo100/issue/IPI-454/ipi-454-cf-ai-001-ai-gateway-cloudflare-provider-routing) **· CF-AI-001** AC-F (`AI_ROUTING_MODE=gateway`) is mergeable / merged
2. Local Wrangler AI Gateway is up **or** remote Worker after [IPI-472](https://linear.app/amo100/issue/IPI-472/infra-001-cloudflare-worker-deployment-pipeline) **· INFRA-001**
3. Marketing/`public-marketing` or operator non-tool chat uses tier `fast`

**Must complete before** claiming AC-J / Mastra→Worker E2E Done.

**Also run:** direct-mode regression (default) so gateway is opt-in safe.

**Re-test when:** resolveModel, Worker chat, or CopilotKit runtime changes; after [IPI-495](https://linear.app/amo100/issue/IPI-495/ipi-492-fu2-cf-ai-004e-chat-error-contract-parity-with-embed-envelope) **· CF-AI-004e** chat error parity.

### Acceptance criteria

- [ ] Gateway mode: request hits Worker; stream reaches CopilotKit
- [ ] Wire uses tier key `fast` (not raw Gemini id)
- [ ] `resolveProviderOptions` empty on gateway path
- [ ] Direct mode still works without Worker
- [ ] Browser smoke (or explicit waiver with stand-in evidence)
- [ ] No secrets in client

### Completion steps

#### A. Env before boot (`AI_ROUTING_MODE=gateway`, gateway URL/key)

#### B. UJ-HEALTH + chat curl + resolveModel stand-in

#### C. Playwright marketing one-turn

#### D. Compare direct vs gateway notes

#### E. Update index readiness → Local/Remote as earned

### Do NOT

* Set `AI_GATEWAY_ALLOW_TOOL_TIERS=1`
* Claim Production Verified without [IPI-472](https://linear.app/amo100/issue/IPI-472/infra-001-cloudflare-worker-deployment-pipeline) remote smoke | Todo |  | High | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-10T20:09:57.190Z | 2026-07-12T05:57:19.677Z |  |  |  |  |  | 2026-07-17T20:09:58.156Z | IPI-500 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | MediumRisk | 30436423-14dd-482a-93e7-f098b5a0309f | 577 | IPI-485, IPI-495, IPI-472 | IPI-454 |  |
| IPI-485 | iPix1 | IPI-485 · MASTRA-CF-001 — Mastra Provider Gateway Cutover | **Priority:** P0 — Foundation
**Status:** ⚪ Backlog (create after [IPI-457](https://linear.app/amo100/issue/IPI-457/ipi-457-cf-ai-005-unified-ai-provider-types-and-registry) merge + [IPI-454](https://linear.app/amo100/issue/IPI-454/ipi-454-cf-ai-001-ai-gateway-cloudflare-provider-routing) AC-F)
...
* [IPI-457](https://linear.app/amo100/issue/IPI-457/ipi-457-cf-ai-005-unified-ai-provider-types-and-registry) — unified types/registry on `main`
* [IPI-454](https://linear.app/amo100/issue/IPI-454/ipi-454-cf-ai-001-ai-gateway-cloudflare-provider-routing) — AC-F Mastra → gateway wire
...
- [ ] Workers AI as default tier flip **blocked** until [IPI-462](https://linear.app/amo100/issue/IPI-462/ipi-462-cf-ai-006-ai-provider-evaluation-suite) eval sign-off
...
* RAG / pgvector ([IPI-141](https://linear.app/amo100/issue/IPI-141/aior-026-rag-foundation-brandassetcampaign-kb) defer)
...
### AI Gateway verification checklist (after cutover)

- [ ] `AI_GATEWAY_URL` configured in env / wrangler vars
- [ ] Gateway worker receives incoming requests from Mastra (confirm via wrangler tail or logs)
- [ ] Gateway routes requests to the correct provider (Workers AI default, Gemini fallback)
- [ ] Streaming works end-to-end: CopilotKit UI receives SSE tokens
- [ ] Structured output (JSON mode / `response_format`) works through gateway
- [ ] Tool calling works through gateway (function definitions forwarded, results returned)
- [ ] Fallback provider works when primary provider returns 5xx / timeout
- [ ] Metrics visible inside Gateway dashboard (request count, latency, error rate per provider)

*Source:* `linear/issues/IPI-MASTRA-CF-001-provider-gateway-cutover.md` | Backlog |  | Urgent | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | MASTRA |  |  |  |  | 2026-07-09T02:50:57.344Z | 2026-07-12T15:33:13.701Z |  |  |  |  |  | 2026-07-10T02:50:58.185Z | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | Breached | da462139-a9a6-4b8b-9692-d8cc323b9437 | 5083 | IPI-462, IPI-457, IPI-508, IPI-487 | IPI-454 |  |
...
**Verification:** Same brand URL → same structured profile output. Compare before/after. | Backlog |  | Urgent | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA, SUPA |  |  |  |  | 2026-07-07T20:16:14.819Z | 2026-07-10T20:09:34.055Z |  |  |  |  |  | 2026-07-08T20:16:15.401Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | Breached | 20579dc8-24c1-4903-9d13-3ec13e270235 | 6918 | IPI-500, IPI-469, IPI-461 |  |  |
...
- [ ] Types regenerated if JSONB columns extended | Backlog | 2 | Urgent | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, GEMINI, MASTRA |  |  |  |  | 2026-06-25T07:59:34.420Z | 2026-07-04T06:56:00.097Z |  |  |  |  |  | 2026-07-01T12:12:54.889Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Breached | 344db2ab-1f61-4700-93a9-61fa4c0de311 | 19420 | IPI-271, IPI-269, IPI-246, IPI-81, IPI-167, IPI-106, IPI-244, IPI-262, IPI-261, IPI-107, IPI-263, IPI-282, IPI-160, IPI-152, IPI2-122, IPI-165 |  |  |
| IPI-505 | iPix1 | IPI-505 · CF-UJ-005 — Journey test: Booking workflow | ## CF-UJ-005 — Journey test: Booking workflow

**Plan:** `tasks/cloudflare/user-journeys/05-booking-workflow.md`
**Parent:** [IPI-500](https://linear.app/amo100/issue/IPI-500/ipi-cf-uj-000-real-world-ai-journey-test-suite) · CF-UJ-000
**Skills:** `mastra` · `copilotkit` · `ipix-supabase`

### When to test (gate)

Run when the **booking AI use case is developed**:

* Routes map to `booking` / `model-match`
* Draft-only guard enforced in tools/routes
* Human confirm creates **exactly one** booking row

**Highest-risk journey** — prioritize automation of duplicate-submit + draft-only.

**Re-test when:** booking schema, draft-only policy, or agent tools change.

### Acceptance criteria

- [ ] Zero confirmed bookings without explicit confirm
- [ ] Double-confirm / double-click → no duplicate
- [ ] RLS blocks other brands
- [ ] AI failure shows recovery; no orphan confirms

### Completion steps

A seed shoot+talent → B scenarios (esp. duplicate) → C Vitest draft-only + Playwright → D SQL count assert → E ship

### Do NOT

* Gateway tool routing
* Weaken draft-only for “easier” tests | Backlog |  | High | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-10T20:09:40.639Z | 2026-07-10T20:10:20.663Z |  |  |  |  |  | 2026-07-17T20:09:41.325Z | IPI-500 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | MediumRisk | c730b482-e045-4dc7-9063-aa69425d0370 | 2604 | IPI-471 |  |  |
| IPI-500 | iPix1 | IPI-500 · CF-UJ-000 — Real-World AI Journey Test Suite | ## CF-UJ-000 — Real-World AI Journey Test Suite

**Role:** iPix QA / engineer. Docs-only plans already live under `tasks/cloudflare/user-journeys/`. This epic tracks **executing** those plans when each product surface is developed — not inventing new product features.

**Plain English:** We do not claim Cloudflare/Mastra AI is “done” until the real operator journeys pass at the right verification level. Each child issue is a journey test pack with an explicit **When to test** gate.

**SSOT:** `tasks/cloudflare/user-journeys/00-index.md`
**Companion:** `tasks/cloudflare/tests/worker-user-journeys.md`

**Skills:** `ipix-task-lifecycle` · `cloudflare` · `mastra` · `copilotkit` · `ipix-supabase` · `mermaid-diagrams`

**Blocked by:** Feature work for each journey (see children) · [IPI-472](https://linear.app/amo100/issue/IPI-472/infra-001-cloudflare-worker-deployment-pipeline) **· INFRA-001** for Remote/Production claims
**Unblocks:** Honest Production Verified sign-off for AI Platform

---

## When to run which journey (order)

\| Order \| Journey \| Run tests when… \|
\| -- \| -- \| -- \|
\| 1 \| J11 Health \| **Continuous** — every AI/Worker PR; before demos \|
\| 2 \| J09 Embeddings \| Worker embed contracts change; before search UI ([IPI-474](https://linear.app/amo100/issue/IPI-474/search-001-ai-search-and-vector-architecture)) \|
\| 3 \| J08 Marketing/`fast` chat \| [IPI-454](https://linear.app/amo100/issue/IPI-454/ipi-454-cf-ai-001-ai-gateway-cloudflare-provider-routing) **· CF-AI-001** AC-F merged + gateway env; browser before AC-J Done \|
\| 4 \| J01 Onboarding \| Onboarding + `brand-intelligence` CopilotKit path is MVP-ready \|
\| 5 \| J02 Brand Intelligence \| Crawl + BI panel ship; re-run after [IPI-455](https://linear.app/amo100/issue/IPI-455/migrate-brand-intelligence-to-cloudflare) \|
\| 6 \| J03 Brand brief \| Brief generate UI / CD tools ship \|
\| 7 \| J04 Shoot planning \| `production-planner` shoot flow ship \|
\| 8 \| J05 Booking \| Booking draft-only agent + confirm UI ship \|
\| 9 \| J07 Planner \| Planner schema + HITL ship \|
\| 10 \| J06 CRM \| `crm-assistant` on CRM routes ship \|
\| 11 \| J10 Visual DNA \| Asset DNA audit UI ship; CF path only after [IPI-456](https://linear.app/amo100/issue/IPI-456/migrate-asset-dna-scoring-to-cloudflare) \|

```mermaid
flowchart TD
  H[J11 Health continuous] --> E[J09 Embed]
  E --> M[J08 Gateway chat]
  M --> O[J01 Onboarding]
  O --> BI[J02 Brand Intelligence]
  BI --> BR[J03 Brief]
  BR --> SH[J04 Shoot]
  SH --> BK[J05 Booking]
  BK --> PL[J07 Planner]
  PL --> CRM[J06 CRM]
  CRM --> DNA[J10 Visual DNA]
```
...
* Default Mastra path = **direct** Gemini/Groq
* Gateway = opt-in `AI_ROUTING_MODE=gateway`, `fast` **only** (no tools/vision on Worker yet)
* Never claim Production Verified without remote Worker ([IPI-472](https://linear.app/amo100/issue/IPI-472/infra-001-cloudflare-worker-deployment-pipeline))

---

## Acceptance criteria

- [ ] All 11 child CF-UJ issues exist and link to their journey markdown
- [ ] Each child has **When to test**, blockedBy feature tasks, and proof commands
- [ ] Index `00-index.md` lists Linear IDs
- [ ] No child marked Done without stated verification level evidence

## Do NOT

* Mix journey automation code with unrelated product PRs
* Enable `AI_GATEWAY_ALLOW_TOOL_TIERS=1` for normal journey sign-off
* Force vision/tool agents through the gateway

## Out of scope

* Implementing missing product features (file under their own IPI)
* Campaign/sponsor journeys not yet productized | Backlog |  | High | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-10T20:09:15.317Z | 2026-07-10T20:10:20.352Z |  |  |  |  |  | 2026-07-17T20:09:16.418Z | IPI-487 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | MediumRisk | a7f26b06-3bc1-4f43-8fe8-436e815b19ef | 2605 | IPI-455, IPI-456, IPI-474, IPI-454, IPI-472 |  |  |
| IPI-482 | iPix1 | Mastra planner AI tools + CopilotKit HITL | **Spec:** `linear/issues/IPI-482-PLN-007-mastra-planner-ai-tools-copilotkit-hitl.md`

## What this builds

AI-powered planning inside the CopilotKit chat sidebar. The Mastra `production-planner` agent provides tools for schedule generation, shift analysis, and gate checks — all requiring explicit human approval (HITL) before writing to the DB.

### AI Schedule Generation with HITL

```mermaid
flowchart TD
    A[User asks: "Build a 5-week schedule for Summer Lookbook"] --> B[Mastra production-planner agent]
...
```mermaid
journey
    title Producer schedules a 5-week shoot with AI
    section Create plan
...
* A — Mastra `production-planner` agent has tools: `buildSchedule`, `shiftTask`, `resolveDependencies`, `checkGate`, `getEffectivePermissions`.
* B — All WRITE tools require CopilotKit HITL (human-in-the-loop) confirmation before executing.
* C — CopilotKit sidepanel shows draft timeline as an A2UI card before commit.
* D — Agent reads current schedule state via RLS (READ tools).
* E — Agent responds in natural language with date summaries, warnings, and explanations. | Backlog |  | High | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca |  | build-on-v2, DESIGNV2, Feature, MASTRA, prefix:INT, track:ai |  |  |  |  | 2026-07-09T01:07:25.095Z | 2026-07-09T05:31:38.222Z |  |  |  |  |  | 2026-07-16T01:07:25.673Z | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | MediumRisk | 455be57d-6ac3-4a5c-a680-e47e8540377a | 5187 | IPI-476, IPI-477, IPI-484 |  |  |
...
**Update 2026-07-10:** `Universal-design-prompt-new/` is now tracked in git (committed this session) — the "DC design files unavailable/confirmed absent" caveat below no longer applies. Before implementation starts, spot-check the chat-dock visual pattern on Brand Detail, Shoot Detail, and one Contact/Company Detail screen against the now-available `.dc.html` sources.
...
\| Module \| Status today \|
\| -- \| -- \|
\| CRM Pipeline / Deal Detail \| `crm/pipeline/page.tsx` + `[id]/page.tsx` — [IPI-395](https://linear.app/amo100/issue/IPI-395/scr-30-crm-pipeline-react-parity) Done, [IPI-396](https://linear.app/amo100/issue/IPI-396/scr-31-crm-deal-detail-react-parity) In Progress \|
...
**Acceptance criteria below are written against the MVP set only.** Phase 2 rows get a registry entry the day their page ships — that's the whole point of the registry pattern.
...
7. Confirm `route-briefing.ts` (`src/components/intelligence-panel/route-briefing.ts`) is genuinely dead code — remove in the same pass or flag separately.
...
`mastra` · `copilotkit` (if available) · `nextjs-developer` · `task-verifier` (pre-implementation gate) · `mermaid-diagrams` (this doc's diagrams) | Backlog | 8 | High | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, COPILOTKIT, FRONTEND, INFRA, MASTRA |  |  |  |  | 2026-07-08T20:25:51.559Z | 2026-07-10T08:11:18.877Z |  |  |  |  |  | 2026-07-15T20:25:52.872Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | MediumRisk | 5960dede-4729-4750-8d60-fdbbc83d4be6 | 5468 | IPI-395, IPI-392 |  |  |
| IPI-470 | iPix1 | AGENT-004 — Cloudflare Workflows & Orchestration | ## Scope clarification (2026-07-09)
...
**Priority:** P1 · **Type:** Architecture · **Estimate:** M
...
* Avoid Cloudflare Workflows unless they reduce complexity over Mastra | Backlog |  | High | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-07T21:56:13.252Z | 2026-07-09T03:11:29.166Z |  |  |  |  |  | 2026-07-14T21:56:14.252Z | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | MediumRisk | 65c28eec-9ded-4b46-8ec9-c040352c1b34 | 6818 | IPI-465, IPI-467, IPI-466 |  |  |
...
`06-model-booking-implementation-plan.md` Phase 3, Blockers #1–#3 (booking-local component naming) · `tasks/models/notes-1.md` (URL-Context spec origin). | Backlog |  | High | 9f12c38f-b20d-492a-ba5b-dd886e8fafef | Model Booking MVP | ai@socialmediaville.ca |  | AI, COPILOTKIT, DESIGN, GEMINI, MASTRA, MODEL, phase:mvp, SUPA |  |  |  |  | 2026-07-01T17:40:51.084Z | 2026-07-04T06:55:52.734Z |  |  |  |  |  | 2026-07-08T17:40:51.862Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | c39cab39-988b-4acc-a1e0-8e65ff7b5919 | M5 · Launch | Breached | 9a22293f-a769-4c8b-a538-84cc73aee38d | 12064 | IPI-311, IPI-347, IPI-307, IPI-344 |  |  |
| IPI-261 | iPix1 | DESIGN-077 · Creative Director Agent — Asset Intelligence Wiring | ## Provider model (2026-07-09 · Mastra × Cloudflare audit)
...
``` | Backlog |  | High | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, COPILOTKIT, DESIGNV2, GEMINI, MASTRA |  |  |  |  | 2026-06-30T06:24:22.044Z | 2026-07-09T02:50:20.246Z |  |  |  |  |  | 2026-07-07T12:16:17.282Z | IPI-254 | IPIX-INIT-001 — Operator Platform (Q3 2026) | 564f6a39-e763-4067-aed2-0926e33c3d3e | DV2-M1 · Shared Spine | Breached | 5eae6d73-fa3a-44d3-a5dc-c07599852046 | 12158 | IPI-172, IPI-259, IPI-248, IPI-246, IPI-247, IPI-23, IPI-197, IPI-152, IPI-268, IPI-156 |  |  |
...
**Do not start Step B until IPI-268 is merged.** | Backlog |  | High | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, COPILOTKIT, DESIGNV2, GEMINI, MASTRA |  |  |  |  | 2026-06-30T06:24:33.252Z | 2026-07-10T08:33:14.206Z |  |  |  |  |  | 2026-07-07T12:12:51.706Z | IPI-254 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | Breached | e5d126d4-7e05-4419-aeeb-a10453ee2cc5 | 12159 | IPI-268, IPI-247, IPI-172, IPI-246, IPI-250, IPI-197, IPI-160 |  |  |
| IPI-262 | iPix1 | DESIGN-078 · Visual Identity Agent — Channel Preview Wiring | ## Provider model (2026-07-09 · Mastra × Cloudflare audit)
...
``` | Backlog |  | High | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, COPILOTKIT, DESIGNV2, GEMINI, MASTRA |  |  |  |  | 2026-06-30T06:24:25.156Z | 2026-07-10T08:33:10.155Z |  |  |  |  |  | 2026-07-07T12:16:17.125Z | IPI-254 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | Breached | a70edc57-8c89-494e-9699-8e821d55395e | 12159 | IPI-269, IPI-247, IPI-172, IPI-259, IPI-246, IPI-188, IPI-191, IPI-338, IPI-197 |  |  |
...
## CAMP-001 — Creative Director Agent (Campaigns)
...
**SSOT:** `docs/prd/campaign-prd.md` · AGENT-MAP · MASTER-DEPENDENCIES | Backlog | 5 | High | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, GEMINI, MASTRA |  |  |  |  | 2026-06-25T07:49:06.936Z | 2026-07-09T02:50:17.954Z |  |  |  |  |  | 2026-07-07T12:12:49.139Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Breached | 80ea6d07-c530-46d1-bfd1-b7088e3af9bd | 12038 | IPI-247, IPI-261, IPI-268, IPI-249, IPI-23, IPI-158 |  |  |
...
- [ ] **A4** Test: re-analyze shows ApprovalCard before DB write | Backlog | 1 | High | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | MASTRA |  |  |  |  | 2026-06-25T07:14:00.845Z | 2026-07-04T06:56:05.525Z |  |  |  |  |  | 2026-07-02T07:14:01.280Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | 57838497-c1a1-43e0-8c70-1ed3394e0ae9 | AGT-M2 · Operator Shell | Breached | eea4a06c-9723-46a2-b7a7-b0fd99f62a67 | 19530 | IPI-274, IPI-111, IPI2-181, IPI-162, IPI-159 |  |  |
| IPI-507 | iPix1 | IPI-507 · CF-UJ-007 — Journey test: Planner workflow | ## CF-UJ-007 — Journey test: Planner workflow

**Plan:** `tasks/cloudflare/user-journeys/07-planner-workflow.md`
**Parent:** [IPI-500](https://linear.app/amo100/issue/IPI-500/ipi-cf-uj-000-real-world-ai-journey-test-suite) · CF-UJ-000
**Skills:** `mastra` · `copilotkit` · `gemini`

### When to test (gate)

Run when the **planner engine + HITL use case is developed**:

* Planner UI accepts goals/channels/dates
* Structured plan output validated by schema before commit
* Accept / edit / reject path persists versioned plan

Related: [IPI-473](https://linear.app/amo100/issue/IPI-473/agent-003-shared-prompt-registry) **· AGENT-003 — Shared Prompt Registry** — re-test after prompt registry if plans drift.

**Re-test when:** output schema version changes.

### Acceptance criteria

- [ ] Invalid JSON never persists as committed
- [ ] Version monotonic on save
- [ ] HITL required before commit
- [ ] Empty inputs validation

### Completion steps

A schema fixture → B scenarios → C Vitest golden + Playwright HITL → D checklist → E ship

### Do NOT

* Persist unvalidated AI output as committed plan | Backlog |  | Medium | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-10T20:09:54.926Z | 2026-07-10T20:10:21.710Z |  |  |  |  |  |  | IPI-500 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  |  | daff7631-187e-40f4-9952-8dff337e02eb | 2604 | IPI-473 |  |  |
| IPI-504 | iPix1 | IPI-504 · CF-UJ-004 — Journey test: Shoot planning workflow | ## CF-UJ-004 — Journey test: Shoot planning workflow

**Plan:** `tasks/cloudflare/user-journeys/04-shoot-planning.md`
**Parent:** [IPI-500](https://linear.app/amo100/issue/IPI-500/ipi-cf-uj-000-real-world-ai-journey-test-suite) · CF-UJ-000
**Skills:** `mastra` · `copilotkit` · `fashion-production`

### When to test (gate)

Run when **shoot planning with** `production-planner` **is developed**:

* `/app/shoots` (or detail) wires CopilotKit to `production-planner`
* Draft plan → human approve → shoot record update path exists

Related DNA-via-Worker ([IPI-282](https://linear.app/amo100/issue/IPI-282/shoot-ai-004b-shoot-dna-scoring-pipeline-via-cloudflare-worker) **· SHOOT-AI-004B**) is a **separate** re-test when that ships — do not block this journey on it.

**Re-test when:** planner tools, HITL, or shoot schema change.

### Acceptance criteria

- [ ] Draft-only until confirm
- [ ] Agent id sync (registry = useAgent)
- [ ] RLS cross-brand blocked
- [ ] Gateway tools not used (document direct path)

### Completion steps

A seed shoot → B scenarios → C Playwright approve gate → D checklist → E ship

### Do NOT

* Route tool calls through AI Gateway Worker | Backlog |  | Medium | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-10T20:09:39.840Z | 2026-07-10T20:10:22.993Z |  |  |  |  |  |  | IPI-500 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  |  | a379dda0-5815-4a24-84d0-be915f1a33f8 | 2604 | IPI-282 |  |  |
| IPI-503 | iPix1 | IPI-503 · CF-UJ-003 — Journey test: AI brand brief generation | ## CF-UJ-003 — Journey test: AI brand brief generation

**Plan:** `tasks/cloudflare/user-journeys/03-ai-brand-brief.md`
**Parent:** [IPI-500](https://linear.app/amo100/issue/IPI-500/ipi-cf-uj-000-real-world-ai-journey-test-suite) · CF-UJ-000
**Skills:** `mastra` · `copilotkit` · `gemini`

### When to test (gate)

Run when the **brief generation use case is developed**:

* UI CTA or tool `suggestShootBrief` (or CD equivalent) returns structured draft
* Human edit + save draft exists
* Brand context (BI or manual fields) available

**Keep AI path direct** until Worker supports tools / [IPI-485](https://linear.app/amo100/issue/IPI-485/ipi-485-mastra-cf-001-mastra-provider-gateway-cutover) **· MASTRA-CF-001** proves otherwise.

**Re-test when:** brief schema version bumps or CD agent tools change.

### Acceptance criteria

- [ ] Structured JSON passes brief schema
- [ ] Draft-only (not auto-published)
- [ ] Malformed AI rejected before save
- [ ] Double-click does not duplicate confirmed brief

### Completion steps

A setup → B scenarios → C Vitest schema → D checklist → E ship

### Do NOT

* Enable `AI_GATEWAY_ALLOW_TOOL_TIERS=1` for sign-off | Backlog |  | Medium | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-10T20:09:36.402Z | 2026-07-10T20:10:20.795Z |  |  |  |  |  |  | IPI-500 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  |  | 9e565195-fdc9-4585-a180-f63370d01ddb | 2605 |  | IPI-485 |  |
| IPI-501 | iPix1 | IPI-501 · CF-UJ-001 — Journey test: AI onboarding | ## CF-UJ-001 — Journey test: AI onboarding

**Plan:** `tasks/cloudflare/user-journeys/01-ai-onboarding.md`
**Parent:** [IPI-500](https://linear.app/amo100/issue/IPI-500/ipi-cf-uj-000-real-world-ai-journey-test-suite) · CF-UJ-000
**Skills:** `copilotkit` · `mastra` · `ipix-supabase` · `cloudflare`

### When to test (gate)

Run this pack **only after** the onboarding / brand first-run surface is considered MVP-developed:

* `/app/onboarding` or `/app/brand` loads for an authenticated operator
* CopilotKit resolves agent `brand-intelligence` via `route-agent-map`
* At least one guided setup turn works on **direct** Gemini (default)

**Do not wait for** Cloudflare gateway cutover — tools stay **direct**. Re-run a gateway smoke only if a non-tool `fast` turn is added later.

**Re-test when:** onboarding UI changes, BI agent tools change, auth/RLS on brand create changes.

### User story

> As a Brand Manager, when I complete first-run setup with AI help, I get a guided brand workspace without guessing next steps.

### Acceptance criteria

- [ ] Happy path: login → onboarding → streamed guidance (Local Runtime)
- [ ] RLS: cannot mutate another brand
- [ ] Duplicate brand/crawl does not double-create
- [ ] Verification level stated (Unit / Local / Remote / Prod) — no over-claim
- [ ] Evidence linked in comment (commands + SHA)

### Completion steps

#### A. Preconditions

- [ ] **A1** QA user + seed brand — proof: login works

#### B. Execute plan scenarios

- [ ] **B1** Happy + empty + cancel from `01-ai-onboarding.md` — proof: notes

#### C. Automate (optional same PR concern)

- [ ] **C1** Playwright smoke or document waiver — proof: test path or waiver

#### D. Verify

- [ ] **D1** Checklist in journey doc signed — proof: comment

#### E. Ship

- [ ] **E1** Update `00-index.md` readiness + Linear Done — proof: link

### Do NOT

* Enable tool tiers on gateway for this journey
* Mark Production Verified without [IPI-472](https://linear.app/amo100/issue/IPI-472/infra-001-cloudflare-worker-deployment-pipeline) remote Worker | Backlog |  | Medium | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-10T20:09:31.253Z | 2026-07-10T20:10:20.138Z |  |  |  |  |  |  | IPI-500 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  |  | c5e24c5b-b2db-4867-978c-85d645aa4e80 | 2605 | IPI-471, IPI-472 | IPI-454 |  |
...
**Phase:** Post-MVP / P2 | Backlog | 3 | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | MASTRA |  |  |  |  | 2026-06-30T11:18:21.551Z | 2026-07-09T02:50:26.144Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | c95a614f-4733-48dc-810c-785fde8c940f | AGT-M3 · Workspaces + Supervisor |  | 18f097df-8f89-49ce-a534-a4fdacb865a6 | 17536 | IPI-129, IPI-133 |  |  |
...
| IPI-259 | iPix1 | DESIGN-075 · Production Planner Agent — Route Wiring | ## Provider model (2026-07-09 · Mastra × Cloudflare audit)
...
``` | Backlog |  | Medium | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca | ai@socialmediaville.ca | COPILOTKIT, DESIGN, DESIGNV2, MASTRA |  |  |  |  | 2026-06-30T06:24:11.487Z | 2026-07-09T02:50:18.866Z |  |  |  |  |  |  | IPI-254 | IPIX-INIT-001 — Operator Platform (Q3 2026) | 564f6a39-e763-4067-aed2-0926e33c3d3e | DV2-M1 · Shared Spine |  | 5f2f5d62-3a8c-465d-820e-2a0358c3282c | 12038 | IPI-247, IPI-17, IPI-23, IPI-262, IPI-261, IPI-197 |  |  |
...
IPI-268 · IPI-263 (soft) · IPI-247 ✅ · IPI-246 ✅ | Backlog |  | Medium | 9f12c38f-b20d-492a-ba5b-dd886e8fafef | Model Booking MVP | ai@socialmediaville.ca | ai@socialmediaville.ca | COPILOTKIT, DESIGN, DESIGNV2, FRONTEND, GEMINI, HTML, MASTRA, QA, SUPA, UX |  |  |  |  | 2026-06-30T06:08:42.893Z | 2026-07-06T09:36:59.850Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | 28c6cce6-f013-403b-ab3a-e0784452558e | M2 · Matching |  | ce94268d-1d0c-4c08-8d33-3320f96d17aa | 17657 | IPI-246, IPI-247, IPI-268, IPI-405, IPI-23, IPI-160, IPI-263 | IPI-172 |  |
...
**Source:** optibot PR #134 review (non-blocking tech debt). | Backlog |  | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | FIX, MASTRA, SUPA |  |  |  |  | 2026-06-28T18:34:36.093Z | 2026-07-04T06:51:31.369Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | 24f5e22e-c856-4422-8b6d-933880a20ac1 | 19980 | IPI-227 |  |  |
| IPI-240 | iPix1 | FIX · Provider options alignment across Mastra tools (gateway-era) | ## FIX · Provider options alignment across Mastra tools (gateway-era)
...
*Source:* `linear/issues/IPI-240-provider-options-alignment.md` | Backlog |  | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | FIX, GEMINI, MASTRA |  |  |  |  | 2026-06-28T14:23:15.794Z | 2026-07-09T03:11:30.839Z |  |  |  |  |  |  | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | fe959a37-f26b-43c7-a4b0-725ed0f7f5e2 | 20231 | IPI-223 |  |  |
...
Blocked by MI-03a (needs the per-placement frame + selection model). | Backlog |  | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | GEMINI, MASTRA, MEDIA, SHOOT, SUPA |  |  |  |  | 2026-06-26T09:20:40.157Z | 2026-07-04T06:51:36.927Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | 8bf50405-65c9-4de6-a088-f9f25dd01372 | 23413 |  | IPI-191 |  |
| IPI-141 | iPix1 | AIOR-026 · RAG foundation (brand/asset/campaign KB) | ## Defer (2026-07-09 audit)

**Status:** Correctly deferred — do not start until dependencies below are green.

**SSOT:** `tasks/cloudflare/mastra/mastra-audit.md`

Blocked by: pgvector pipeline + content ingestion stable.

---

## AIOR-026 — RAG Foundation (brand/asset/campaign KB)
...
- [ ] No RAG until normal vector path proves value (per defer list) | Backlog | 5 | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | MASTRA |  |  |  |  | 2026-06-25T07:48:39.187Z | 2026-07-09T02:50:25.340Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | baa4ce4c-1238-4ab5-a3c2-920b45056664 | AGT-M4 · Observability + RAG |  | 3c73685c-2ad6-413a-9937-24fe490c785e | 12038 |  |  |  |
...
- [ ] No secrets in client bundle | Backlog | 3 | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | CLOUDINARY, MASTRA |  |  |  |  | 2026-06-25T07:48:33.034Z | 2026-07-04T06:56:05.070Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | c95a614f-4733-48dc-810c-785fde8c940f | AGT-M3 · Workspaces + Supervisor |  | f8f34e72-852b-44c2-b7ae-79cd8f8d57f6 | 12038 |  |  |  |
...
- [ ] `npm run build` green | Backlog | 2 | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | MASTRA |  |  |  |  | 2026-06-25T07:48:52.694Z | 2026-07-04T06:56:01.741Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | 7f71e821-e2c7-4471-85ca-b519026a83d8 | 12038 | IPI-113 |  |  |
...
- [ ] `infisical run -- npm run supabase:verify-dna` green | Backlog | 5 | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, GEMINI, MASTRA |  |  |  |  | 2026-06-25T07:49:00.686Z | 2026-07-04T06:56:01.295Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | 4e3fd9c9-ae53-43cc-8171-7baa1ce8d8b6 | 12038 | IPI-170, IPI-155, IPI-261, IPI-172, IPI-248, IPI-246, IPI-129, IPI-265 |  |  |
...
- [ ] Rate limits + audit log entry per run | Backlog | 5 | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | MASTRA |  |  |  |  | 2026-06-25T07:48:34.117Z | 2026-07-04T06:56:04.844Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | c95a614f-4733-48dc-810c-785fde8c940f | AGT-M3 · Workspaces + Supervisor |  | 937c9a6a-6e5e-47c5-9a66-16cffe3ccfa7 | 12038 |  |  |  |
...
- [ ] No direct DB writes — delegate to workflows / edge fns | Backlog | 8 | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, MASTRA |  |  |  |  | 2026-06-14T12:18:20.325Z | 2026-07-04T06:51:59.308Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | c95a614f-4733-48dc-810c-785fde8c940f | AGT-M3 · Workspaces + Supervisor |  | 2aff1adb-4265-4d67-87da-ee7cae8a0ada | 40516 | IPI-132, IPI-104, IPI2-128 | IPI2-87, IPI2-86 |  |
| IPI-511 | iPix1 | IPI-511 · CF-UJ-010 — Journey test: Visual DNA analysis | ## CF-UJ-010 — Journey test: Visual DNA analysis

**Plan:** `tasks/cloudflare/user-journeys/10-visual-dna-analysis.md`
**Parent:** [IPI-500](https://linear.app/amo100/issue/IPI-500/ipi-cf-uj-000-real-world-ai-journey-test-suite) · CF-UJ-000
**Skills:** `mastra` · `gemini` · `cloudinary` · `ipix-supabase`

### When to test (gate)

**First run** when asset DNA audit use case is developed:

* Asset UI triggers `audit-asset-dna` and/or Mastra `visual-identity` (vision)
* Score + rationale shown (approved/review/blocked)

**Always direct Gemini vision** — Worker has no ImageParts. Assert **no** gateway hop.

**Second run** only after [IPI-456](https://linear.app/amo100/issue/IPI-456/migrate-asset-dna-scoring-to-cloudflare) **· Migrate Asset DNA Scoring to Cloudflare** (and/or [IPI-282](https://linear.app/amo100/issue/IPI-282/shoot-ai-004b-shoot-dna-scoring-pipeline-via-cloudflare-worker)) if CF vision path is invented — do not invent early.

**Re-test when:** DNA schema, Cloudinary URLs, or vision model registry change.

### Acceptance criteria

- [ ] Happy path scores valid enum + rationale
- [ ] Missing image validation
- [ ] Documented: vision stays direct
- [ ] RLS on asset rows

### Completion steps

A sample assets → B scenarios → C edge DNA verify script → D assert no Worker vision → E ship

### Do NOT

* Force vision through AI Gateway | Backlog |  | Low | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-10T20:10:06.210Z | 2026-07-10T20:10:22.645Z |  |  |  |  |  |  | IPI-500 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  |  | 0e428a0d-4fb3-4ce9-a3fb-197d4113c94f | 2604 | IPI-282 | IPI-456 |  |
| IPI-506 | iPix1 | IPI-506 · CF-UJ-006 — Journey test: CRM workflow | ## CF-UJ-006 — Journey test: CRM workflow

**Plan:** `tasks/cloudflare/user-journeys/06-crm-workflow.md`
**Parent:** [IPI-500](https://linear.app/amo100/issue/IPI-500/ipi-cf-uj-000-real-world-ai-journey-test-suite) · CF-UJ-000
**Skills:** `mastra` · `copilotkit` · `ipix-supabase`

### When to test (gate)

Run when **CRM assistant use case is developed**:

* `/app/crm` (or deals) wires `crm-assistant`
* Read/summarize + draft suggestions work; writes are gated

**Priority P2** — after booking/planner if capacity limited.

**Re-test when:** CRM schema, tools, or RLS policies change.

### Acceptance criteria

- [ ] Pipeline summary happy path
- [ ] Unauthorized write denied (RLS/tool)
- [ ] No cross-tenant deal leak
- [ ] Empty pipeline empty-state

### Completion steps

A seed deals → B scenarios → C Playwright one-turn → D RLS SQL → E ship

### Do NOT

* Let AI silently close/won deals without HITL | Backlog |  | Low | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-10T20:09:40.990Z | 2026-07-10T20:10:20.993Z |  |  |  |  |  |  | IPI-500 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  |  | 191df7f6-729a-4076-94fc-c9e45858a1bf | 2604 |  |  |  |
| IPI-333 | iPix1 | BOOK-211 — Additional Mastra Agents | ## Defer (2026-07-09 audit)

**Status:** Correctly deferred — do not start until dependencies below are green.

**SSOT:** `tasks/cloudflare/mastra/mastra-audit.md`

Defer — add tools to existing agents before new agent shells.

---

Casting, Contract, Analytics, Notification, Pricing agents. Gate: only spin up a dedicated agent if the corresponding capability above ships **and** genuinely needs agent-level autonomy — default to adding a tool to Model Match/Booking Agent first, per the existing `production-planner` pattern. Source: `tasks/models/05-model-booking-post-mvp-and-advanced.md`. | Backlog |  | Low | 9f12c38f-b20d-492a-ba5b-dd886e8fafef | Model Booking MVP | ai@socialmediaville.ca |  | MASTRA, MODEL |  |  |  |  | 2026-07-01T18:09:55.708Z | 2026-07-09T02:50:27.012Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | c39cab39-988b-4acc-a1e0-8e65ff7b5919 | M5 · Launch |  | d5c5ef2c-3da4-4cdf-96b8-3e2c5e7073a5 | 15684 |  |  |  |
| IPI-329 | iPix1 | BOOK-207 — Automation & Reminder Workflows | Follow-ups, review requests, post-shoot task automation. Gate: needs BOOK-102 (real notifications) first. Source: `tasks/models/05-model-booking-post-mvp-and-advanced.md`. | Backlog |  | Low | 9f12c38f-b20d-492a-ba5b-dd886e8fafef | Model Booking MVP | ai@socialmediaville.ca |  | MASTRA, MODEL |  |  |  |  | 2026-07-01T18:09:32.651Z | 2026-07-04T06:52:17.673Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | c39cab39-988b-4acc-a1e0-8e65ff7b5919 | M5 · Launch |  | 72fe770b-4eed-4697-81f6-7746bbf00802 | 15685 |  |  |  |
...
**Phase:** Post-MVP | Backlog | 5 | Low | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | MASTRA |  |  |  |  | 2026-06-30T11:18:25.099Z | 2026-07-04T06:51:29.958Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | f97968d6-9c20-41ef-a641-c69858e444a9 | 17536 | IPI-135, IPI-136, IPI-142 | IPI-143 |  |
...
\| 8 \| `/ponytail` \| No generateText in route — tool.execute!() only \|
 | Backlog |  | Low | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, GEMINI, MASTRA, SHOOT, SUPA |  |  |  |  | 2026-06-28T12:18:10.913Z | 2026-07-04T06:55:58.278Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | a7c3b628-bf86-495c-b65b-9219015ab0e5 | 12059 | IPI-337 |  |  |
...
**Related:** [IPI-163](https://linear.app/amo100/issue/IPI-163) · [IPI-250](https://linear.app/amo100/issue/IPI-250) | Backlog | 5 | Low | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, MASTRA |  |  |  |  | 2026-06-25T07:49:12.060Z | 2026-07-04T06:51:39.384Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | 1d7378b4-db94-4f5c-9a82-e6b02258ce14 | 17484 | IPI-268, IPI-134 | IPI-160 |  |
...
**Related:** [IPI-263](https://linear.app/amo100/issue/IPI-263) · [IPI-250](https://linear.app/amo100/issue/IPI-250) · [IPI-169](https://linear.app/amo100/issue/IPI-169) maps grounding | Backlog | 5 | Low | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, GEMINI, MASTRA |  |  |  |  | 2026-06-25T07:49:11.045Z | 2026-07-04T06:51:39.732Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | 66ba10bc-b611-43be-82b4-1c33d96f68c0 | 17495 | IPI-169, IPI-172, IPI-250, IPI-263, IPI-268, IPI-163 |  |  |
...
**Source:** `docs/prd/campaign-prd.md` | Backlog | 5 | Low | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, MASTRA |  |  |  |  | 2026-06-25T07:49:07.870Z | 2026-07-04T06:51:40.465Z |  |  |  |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | 624ebd7d-71b3-4fc2-9bd0-e10819b73ad0 | 17485 | IPI-158, IPI-268, IPI-134 | IPI-156 |  |
...
**Status:** ✅ Done (architecture documented on main)
**Proof:** 7-agent content documented on main at `tasks/cloudflare/cf-000-platform-architecture.md` (169 lines, landed via commit `6eb689f9` in PR #296)

## Deliverable ✅

Architecture document covering all 7 agents on main:
...
- [X] Architecture document exists on main
- [X] 7 agents documented with clear definitions
- [X] Current state vs target mapped
- [X] Communication patterns defined
- [X] Runtime decision matrix included
- [X] Follow-up work (provider types in [IPI-457](https://linear.app/amo100/issue/IPI-457/ipi-457-cf-ai-005-unified-ai-provider-types-and-registry)) clearly scoped

**Verdict:** Done. Architecture is documented and approved. Provider types implementation tracked separately under [IPI-457](https://linear.app/amo100/issue/IPI-457/ipi-457-cf-ai-005-unified-ai-provider-types-and-registry). | Done |  | Urgent | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-07T21:56:16.757Z | 2026-07-12T06:21:42.175Z | 2026-07-07T22:24:18.687Z |  | 2026-07-12T06:21:42.082Z |  |  | 2026-07-08T21:56:17.636Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | Failed | 2639f769-5376-474e-972f-17b4200b9acc | 552 | IPI-457, IPI-465, IPI-505, IPI-501 |  |  |
| IPI-461 | iPix1 | IPI-461 · CF-AI-004 — AI Provider Adapter (sub-task of IPI-454) | ## [IPI-461](https://linear.app/amo100/issue/IPI-461/ipi-461-cf-ai-004-ai-provider-adapter-sub-task-of-ipi-454) · CF-AI-004 — AI Provider Adapter

**Status:** ✅ **Done** (2026-07-10) — local Done gate Pass on `origin/main` `d112dea4` after [IPI-491](https://linear.app/amo100/issue/IPI-491/ipi-491-cf-ai-004b-fix-ai-gateway-embeddings-adapter-workers-ai) / PR #316.

**SSOT:** `app/src/lib/ai/provider-adapter.ts` · `services/cloudflare-worker/`
...
\| -- \| -- \|
\| health \| Pass \|
\| chat / structured / stream / cancel \| Pass \|
\| embed() \| Pass — 768-d Workers AI BGE \|
\| Unit \| adapter 24 + Worker 23 \|

Evidence: `tasks/cloudflare/tests/pr-315-316-post-merge-audit-2026-07-10.md`

**Not claimed:** Production Verified → [IPI-472](https://linear.app/amo100/issue/IPI-472/infra-001-cloudflare-worker-deployment-pipeline).

## Boundary vs AC-F

Mastra `resolveModel()` → gateway is [IPI-454](https://linear.app/amo100/issue/IPI-454/ipi-454-cf-ai-001-ai-gateway-cloudflare-provider-routing) **AC-F** (separate). This issue owns the REST `createProviderAdapter()` runtime.

## History

* PR #310 — runtime factory + `:8787` + `/api/ai/health`
* PR #312 — Gemini non-stream (sibling)
* PR #316 / [IPI-491](https://linear.app/amo100/issue/IPI-491/ipi-491-cf-ai-004b-fix-ai-gateway-embeddings-adapter-workers-ai) — embeddings fix | Done |  | Urgent | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, CLOUDFLARE, MASTRA |  |  |  |  | 2026-07-07T20:25:28.583Z | 2026-07-11T16:59:36.370Z | 2026-07-07T22:37:15.084Z |  | 2026-07-10T16:05:26.881Z |  |  | 2026-07-08T20:25:29.324Z | IPI-487 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  | Failed | ddd19656-3b37-4819-b072-8d48d6fa8123 | 2795 | IPI-455, IPI-454, IPI-456, IPI-491, IPI-457, IPI-490, IPI-469, IPI-463, IPI-462 |  |  |
...
**One concern per PR** — code only, no docs in same PR. | Done | 1 | Urgent | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, MASTRA |  |  |  |  | 2026-06-30T11:18:15.598Z | 2026-07-09T03:11:35.291Z | 2026-06-30T12:21:53.853Z |  | 2026-06-30T12:59:53.807Z |  |  | 2026-07-01T12:13:04.252Z | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Completed | b3f04f6d-1a03-4e82-8d11-931d071c3c88 | 17434 | IPI-257 |  |  |
...
* Operator closes laptop → reopens within cache TTL → seamless continuation | Done | 5 | Urgent | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | MASTRA |  |  |  |  | 2026-06-25T07:48:25.577Z | 2026-07-09T03:11:33.098Z | 2026-06-25T21:28:22.946Z |  | 2026-06-25T21:43:21.662Z |  |  | 2026-06-26T07:48:26.448Z | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Completed | 3fae3e21-557a-4694-b506-38023d29da22 | 24126 | IPI-279, IPI-129 |  |  |
...
**Follow-up:** Durable stream cache → [IPI-279](https://linear.app/amo100/issue/IPI-279) (AIOR-017b) | Done | 5 | Urgent | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | MASTRA |  |  |  |  | 2026-06-25T07:48:29.419Z | 2026-07-09T03:11:34.580Z | 2026-06-25T23:22:43.523Z |  | 2026-06-26T04:02:16.195Z |  |  | 2026-06-26T07:48:30.236Z | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Completed | 2b6fb71b-7734-469b-9cbc-4937d6265165 | 23753 | IPI-136, IPI-129, IPI-104, IPI-280 |  |  |
...
- [ ] Document in `app/src/mastra/workflows/README.md` | Done | 5 | Urgent | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | MASTRA |  |  |  |  | 2026-06-25T07:48:26.640Z | 2026-07-09T03:11:33.881Z |  |  | 2026-06-25T23:21:43.616Z |  |  | 2026-06-26T07:48:29.106Z | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Completed | e5dbe1b7-f288-46c8-8954-04daa4b9ac13 | 24012 | IPI-161, IPI-157, IPI-148, IPI-129, IPI-83, IPI-149 |  |  |
...
CopilotKit approval cards wired to same commit edge — tracked separately if needed. | Done | 8 | Urgent | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | MASTRA |  |  |  |  | 2026-06-25T07:48:22.859Z | 2026-07-09T03:11:32.360Z |  |  | 2026-06-28T00:02:39.656Z |  |  | 2026-06-26T07:48:25.369Z | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Failed | f19e2c3d-15a1-4fca-99d6-dc248199e7ea | 21091 | IPI-52, IPI-109, IPI-99, IPI-296, IPI2-18, IPI2-174, IPI2-23, IPI2-129, IPI-18, IPI-88, IPI-23, IPI-84, IPI-81, IPI-48, IPI-113, IPI-110, IPI-107, IPI2-86, IPI-111, IPI2-72, IPI2-128, IPI-29, IPI-25 |  |  |
...
*Source:* `docs/linear/issues/IPI-105-AIOR-013.md` | Done | 3 | Urgent | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | MASTRA |  |  |  |  | 2026-06-25T07:13:56.452Z | 2026-07-09T03:11:31.579Z | 2026-06-25T21:05:25.543Z |  | 2026-06-25T22:35:16.915Z |  |  | 2026-06-26T07:13:57.348Z | IPI-486 | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Completed | 1668653e-4784-46c8-ac12-065170e38ca3 | 24059 | IPI-152, IPI-183, IPI-148, IPI-81, IPI-48, IPI-279, IPI-149, IPI-135, IPI-134, IPI-133 |  |  |
...
*Source:* `docs/linear/issues/IPI-81-AIOR-001.md` *· push via* `node scripts/linear-update-issue.mjs IPI-81` | Done | 5 | Urgent | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, COPILOTKIT, MASTRA |  |  |  |  | 2026-06-14T12:18:15.303Z | 2026-07-04T06:52:00.599Z |  |  | 2026-06-22T14:53:43.382Z |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | e49d049d-172d-40f8-8a43-0a3e80d65122 | 28840 | IPI-132, IPI-130, IPI-129, IPI2-128, IPI-105, IPI-104, IPI-113, IPI-110, IPI2-129, IPI2-16, IPI-127, IPI2-176 |  |  |
...
gantt
  ...
  Verify :crit, v1, after b1, 1d
  Done :milestone, m1, after v1, 0d
``` | Done |  | High | 51b8b9e3-a396-4bcf-a531-ef8b1ea3dce7 | CRM — Relationship Layer | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, COPILOTKIT, CRM, MASTRA |  |  |  |  | 2026-07-04T07:01:20.462Z | 2026-07-12T15:07:18.150Z | 2026-07-04T10:06:54.263Z |  | 2026-07-05T18:55:32.053Z |  |  | 2026-07-11T07:01:38.667Z |  |  | 82d68607-87e5-4c4c-b0eb-1055e0e92c4c | CRM-M3 · crm-assistant Agent | Completed | 0cf7a954-3812-4219-b4c7-e0f78c5a6aed | 9879 | IPI-367, IPI-362, IPI-363, IPI-364, IPI-568, IPI-388, IPI-374 |  |  |
...
\| 3-col BrandCard grid \| *from DC* \| *§0 Prove* \| *EmptyState* \|
 | Done |  | High | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca |  | BRAND, COPILOTKIT, DESIGN, DESIGNV2, FRONTEND, HTML, MASTRA, QA, UX |  |  |  |  | 2026-06-30T09:04:23.134Z | 2026-07-06T09:51:15.592Z | 2026-07-02T17:43:15.051Z |  | 2026-07-06T09:07:02.763Z |  |  | 2026-07-08T13:16:26.301Z | IPI-254 | IPIX-INIT-001 — Operator Platform (Q3 2026) | a3b8be45-5b64-4b60-92f2-c733831784b1 | DV2-M3 · Workspace Parity | Completed | 69a44345-29a3-4570-9b03-5538ef4a2595 | 9027 | IPI-258, IPI-243, IPI-275, IPI-270, IPI-271, IPI-247, IPI-260, IPI-23 |  |  |
...
\| Step content + review grid \| *from DC* \| *§0 Prove* \| *EmptyState* \|
 | Done |  | High | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca | ai@socialmediaville.ca | COPILOTKIT, DESIGN, DESIGNV2, FRONTEND, GEMINI, HTML, MASTRA, QA, SHOOT, UX |  |  |  |  | 2026-06-30T09:04:30.625Z | 2026-07-06T09:51:16.279Z | 2026-07-05T05:44:29.207Z |  | 2026-07-05T23:33:17.971Z |  |  | 2026-07-07T09:11:33.325Z | IPI-254 | IPIX-INIT-001 — Operator Platform (Q3 2026) | a3b8be45-5b64-4b60-92f2-c733831784b1 | DV2-M3 · Workspace Parity | Completed | c03e8e1c-80a2-4427-83e4-bac9769097d7 | 9601 | IPI-420, IPI-258, IPI2-117, IPI-246, IPI-112, IPI-275, IPI-149, IPI-252, IPI-184, IPI-209, IPI-84, IPI-183, IPI-384, IPI-131, IPI-148, IPI-85, IPI-88, IPI2-112, IPI2-110, IPI2-113, IPI2-128, IPI-111, IPI-273 |  |  |
...
\| Tab panel (Overview/DNA/Shoots/Assets) \| *from DC* \| *§0 Prove* \| *EmptyState* \|
 | Done |  | High | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca |  | AI, BRAND, COPILOTKIT, DESIGN, DESIGNV2, FRONTEND, GEMINI, HTML, MASTRA, QA, UX |  |  |  |  | 2026-06-30T09:04:19.740Z | 2026-07-06T09:51:14.834Z | 2026-07-02T17:43:17.499Z |  | 2026-07-06T09:07:02.033Z |  |  | 2026-07-08T13:16:23.914Z | IPI-254 | IPIX-INIT-001 — Operator Platform (Q3 2026) | a3b8be45-5b64-4b60-92f2-c733831784b1 | DV2-M3 · Workspace Parity | Completed | 5ed5a7c7-f54c-49fc-8f4b-0b82e79937d3 | 9027 | IPI-258, IPI-246, IPI-248, IPI-275, IPI-260, IPI-247, IPI-46, IPI-30, IPI-172, IPI-272, IPI-23 |  |  |
...
**Blocked by:** [IPI-47](https://linear.app/amo100/issue/IPI-47/ai-009-31-flash-lite-ga-default) partial OK — mock structured payload acceptable until Gemini foundation Done.

**Does NOT block:** [IPI-247](https://linear.app/amo100/issue/IPI-247/design-070-route-agent-map-parity-assets-matching-preview) route map · [IPI-243](https://linear.app/amo100/issue/IPI-243/intel-001-build-intelligencepanel-context-dna-assets-suggestions-chat) panel shell · [IPI-261](https://linear.app/amo100/issue/IPI-261/design-077-creative-director-agent-asset-intelligence-wiring)/262/263 agent route wiring (only explain UX on scores)

---

## Acceptance criteria

- [X] Single component `app/src/components/evidence-block/` — no forks
- [X] HITL Approve/Reject gates AI re-score
- [ ] Wired on 5 screens — **corrected 2026-07-10:** re-verified via grep, only **2 of 5** screens actually import `EvidenceBlock`/`evidence-dialog`: Brand Detail (`brand-detail-workspace.tsx`) and Matching (`talent-tab.tsx`). Assets, Campaigns, and Channel Preview still don't consume it.
- [ ] Mobile sheet ≤1024px
...
**Blocks:** [IPI-248](https://linear.app/amo100/issue/IPI-248/design-057-asset-library-react-parity-workspace)–250 explain flows · [IPI-209](https://linear.app/amo100/issue/IPI-209/ipi-209-design-054-shoot-detail-workspace) Assets tab · [IPI-269](https://linear.app/amo100/issue/IPI-269/design-060-channel-preview-react-parity-dv2-refresh) preview explain

**Depends on:** [IPI-47](https://linear.app/amo100/issue/IPI-47/ai-009-31-flash-lite-ga-default) partial (waiver OK with mock data)

**SSOT:** MASTER-DEPENDENCIES | Done |  | High | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, COPILOTKIT, DESIGN, DESIGNV2, GEMINI, MASTRA, SUPA, UX |  |  |  |  | 2026-06-30T06:08:20.736Z | 2026-07-10T08:11:55.552Z | 2026-06-30T07:38:18.464Z |  | 2026-06-30T10:30:20.652Z |  |  | 2026-07-07T06:08:21.873Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | 564f6a39-e763-4067-aed2-0926e33c3d3e | DV2-M1 · Shared Spine | Completed | 2c00eff7-d79c-44b8-91a1-77f194344bb9 | 17605 | IPI-152, IPI-107, IPI-47, IPI-274, IPI-269, IPI-271, IPI-250, IPI-249, IPI-248, IPI-244, IPI-172, IPI-261, IPI-263, IPI-262, IPI-209, IPI-243, IPI-265 |  |  |
...
**SSOT:** MASTER-DEPENDENCIES · Batch 1 #2 | Done |  | High | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, COPILOTKIT, DESIGN, DESIGNV2, MASTRA |  |  |  |  | 2026-06-30T06:08:24.501Z | 2026-07-01T15:26:18.161Z | 2026-06-30T07:36:13.994Z |  | 2026-06-30T07:58:03.338Z |  |  | 2026-07-07T06:08:25.165Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | 564f6a39-e763-4067-aed2-0926e33c3d3e | DV2-M1 · Shared Spine | Completed | c6be7285-b98a-45e3-9f16-79781fcf991c | 17736 | IPI-248, IPI-261, IPI-197, IPI-255, IPI-17, IPI-260, IPI-275, IPI-262, IPI-259, IPI-271, IPI-250, IPI-249, IPI-269, IPI-263, IPI-156, IPI-272, IPI-51 |  |  |
...
* Playwright spec (IPI-258 epic) | Done |  | High | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca | ai@socialmediaville.ca | COPILOTKIT, DESIGN, DESIGNV2, FRONTEND, GEMINI, HTML, MASTRA, QA, SHOOT, SUPA, UX |  |  |  |  | 2026-06-28T12:02:57.535Z | 2026-07-04T08:41:42.823Z | 2026-06-28T13:13:05.680Z |  | 2026-06-30T08:13:03.999Z |  |  | 2026-07-05T12:02:58.298Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | a3b8be45-5b64-4b60-92f2-c733831784b1 | DV2-M3 · Workspace Parity | Completed | 87e4a073-9e1e-4d5c-b0f5-ef6032b2fa88 | 17721 | IPI-274, IPI-258, IPI-246, IPI-84, IPI-85, IPI-184, IPI-183, IPI-337, IPI-273, IPI2-128, IPI2-110 |  |  |
| IPI-229 | iPix1 | FIX · social-discovery edge deploy or retire | ## FIX · Phase 2.3 — social-discovery edge deploy or retire

**Status:** 🟢 **Done** — [amo-tech-ai/lumina-studio#139](https://linear.app/amo100/review/ipi-229-fix-social-discovery-path-b-shared-lib-no-edge-fn-04870c6382e0) merged 2026-06-29 (corrected 2026-07-10 — description previously said "In Review")
**Parent:** [IPI-222](https://linear.app/amo100/issue/IPI-222/fix-june-28-audit-production-certification-epic) · **Audit:** Phase 2.3 fix plan
**Decision (locked):** **Option B — Path B** (same pattern as [IPI-228](https://linear.app/amo100/issue/IPI-228/fix-shoot-commit-via-apishootscommit-rpc) shoot commit). Mastra tool writes via shared server lib; **do not deploy** edge fn.
...
\| ID \| Story \| Acceptance \|
\| -- \| -- \| -- \|
\| US-4 \| **As an** operator on Brand Hub, **I want** discovered channels to persist in the database after intake, **so that** channel preview and shoot wizard can reference them later. \| Rows in `brand_social_channels` after workflow (V-005 / [IPI-233](https://linear.app/amo100/issue/IPI-233/fix-workflow-runtime-chains-apidb-v-005)) \|
...
\| -- \| -- \| -- \|
\| Edge fn in repo \| ✅ `supabase/functions/social-discovery/` \| ⏭️ corpse → [IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004) delete \|
...
\| Rule \| [IPI-229](https://linear.app/amo100/issue/IPI-229/fix-social-discovery-edge-deploy-or-retire) application \|
\| -- \| -- \|
\| **When to use edge** \| Public webhooks, JWT user-scoped writes, Gemini at edge without Next.js \|
\| **When NOT to use edge** \| Server-only Mastra tool writes with service_role — use shared lib or `/api/*` ([IPI-228](https://linear.app/amo100/issue/IPI-228/fix-shoot-commit-via-apishootscommit-rpc) precedent) \|
...
\| **Inventory sync** \| Repo fn not deployed → **retire** from repo + update inventory ([IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004)), not deploy orphan \|
...
**Path B rationale:** Edge fn duplicated logic already runnable in Next.js runtime; undeployed corpse caused production gap. Aligns with shoot commit Path B ([IPI-228](https://linear.app/amo100/issue/IPI-228/fix-shoot-commit-via-apishootscommit-rpc)).
...
**Follow-up (**[IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004) **— edge-only PR):**
...
### Edge inventory ([IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004) — post-merge)
...
\| -- \| -- \| -- \|
\| `social-discovery` \| ❌ never deployed \| **Delete from repo** ([IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004)) \|
\| `save-approved-shoot-draft` \| ❌ \| [IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004) ([IPI-228](https://linear.app/amo100/issue/IPI-228/fix-shoot-commit-via-apishootscommit-rpc) retired call path) \|
\| `health`, `brand-intelligence`, … \| ✅ \| Keep \|

### Runtime chain ([IPI-233](https://linear.app/amo100/issue/IPI-233/fix-workflow-runtime-chains-apidb-v-005) — V-005, post-cert)
...
- [X] PR #139 merged
- [ ] Edge fn directory deleted → [IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004)
- [ ] V-005 live chain → [IPI-233](https://linear.app/amo100/issue/IPI-233/fix-workflow-runtime-chains-apidb-v-005)

**Blocks:** V-005 social channel writes (was broken pre-#139)
**Related:** [IPI-228](https://linear.app/amo100/issue/IPI-228/fix-shoot-commit-via-apishootscommit-rpc) Path B pattern · [IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004) edge inventory
...
## [IPI-229](https://linear.app/amo100/issue/IPI-229/fix-social-discovery-edge-deploy-or-retire) Audit Report
...
\| Edge fn retirement deferred to [IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004) \| ✅ \| `supabase/functions/social-discovery/` still in repo \|
\| Tests 7/7 (lib + tool) \| ✅ \| vitest run 2026-06-28 \|
\| Runtime V-005 deferred to [IPI-233](https://linear.app/amo100/issue/IPI-233/fix-workflow-runtime-chains-apidb-v-005) \| ✅ \| No live workflow smoke yet \|
...
\| -- \| -- \| -- \| -- \|
\| Edge corpse still in repo \| 🟡 Medium \| Open \| [IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004) delete fn + inventory \|
\| Runtime not proven \| 🟡 Medium \| Open \| [IPI-233](https://linear.app/amo100/issue/IPI-233/fix-workflow-runtime-chains-apidb-v-005) V-005 chain \|
...
PR #139 is **mergeable** with green CI + 7/7 tests. **Certification cannot pass** until [IPI-233](https://linear.app/amo100/issue/IPI-233/fix-workflow-runtime-chains-apidb-v-005) proves this chain live.
...
* **Edge Functions:** Orphan undeployed fn adds inventory drift without runtime value — retire ([IPI-231](https://linear.app/amo100/issue/IPI-231/fix-supabase-verify-suite-edge-inventory-v-003v-004)) rather than deploy.
...
\| Area \| Score \| Notes \|
\| -- \| -- \| -- \|
\| Architecture \| 92 \| Path B matches [IPI-228](https://linear.app/amo100/issue/IPI-228/fix-shoot-commit-via-apishootscommit-rpc) \|
...
\| Runtime proof \| 65 \| blocked → [IPI-233](https://linear.app/amo100/issue/IPI-233/fix-workflow-runtime-chains-apidb-v-005) \|
\| Documentation \| 90 \| Linear spec + mermaid \|

**Overall: 88/100** — mergeable with follow-up; not certification-ready yet. | Done |  | High | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | FIX, MASTRA, SUPA |  |  |  |  | 2026-06-28T14:22:26.303Z | 2026-07-10T08:40:17.165Z | 2026-06-28T21:41:14.866Z |  | 2026-06-29T20:39:00.748Z |  |  | 2026-07-05T14:22:26.712Z | IPI-222 | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Completed | ec932af7-ba8f-4c76-911c-eebf057c134e | 18415 | IPI-228, IPI-231 |  |  |
...
- [ ] `npm run build` green in `app/` | Done | 5 | High | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | MASTRA, SHOOT |  |  |  |  | 2026-06-25T07:48:55.672Z | 2026-07-04T06:51:42.063Z | 2026-06-25T22:24:55.634Z |  | 2026-06-26T01:45:10.268Z |  |  | 2026-07-02T07:48:56.295Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Completed | 0e73c49a-9575-4c09-b0d5-40542fac358c | 23869 | IPI-150, IPI-129, IPI-134, IPI-115, IPI-148, IPI-183, IPI-274 |  |  |
...
**Probe:** `rg shoot_portfolio_view app/src/app/\(operator\)/app/shoots/page.tsx` | Done | 5 | High | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, COPILOTKIT, DESIGN, MASTRA, SHOOT, SUPA, UX |  |  |  |  | 2026-06-20T04:33:15.100Z | 2026-07-04T08:41:51.658Z |  |  | 2026-07-03T02:44:00.924Z |  |  | 2026-07-07T12:06:31.548Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Completed | 5f83eed9-d531-4b92-b0f1-5968c72f9a6e | 13730 | IPI-274, IPI-110, IPI-128, IPI-112, IPI-183, IPI-51, IPI-84, IPI-372, IPI-88, IPI-273, IPI-209, IPI-148, IPI2-128, IPI2-110 |  |  |
...
## Gaps closed by [IPI-247](https://linear.app/amo100/issue/IPI-247/design-070-route-agent-map-parity-assets-matching-preview) (2026-06-30, verified 2026-07-10)

All four routes below were fixed and shipped via [IPI-247](https://linear.app/amo100/issue/IPI-247/design-070-route-agent-map-parity-assets-matching-preview) (PR #147, merged) — no longer a gap:

\| Route \| Target (AGENT-MAP) \| Status \|
\| -- \| -- \| -- \|
\| `/app/assets` \| creative-director \| ✅ shipped ([IPI-247](https://linear.app/amo100/issue/IPI-247/design-070-route-agent-map-parity-assets-matching-preview)) \|
\| `/app/matching` \| social-discovery \| ✅ shipped ([IPI-247](https://linear.app/amo100/issue/IPI-247/design-070-route-agent-map-parity-assets-matching-preview)) \|
\| `/app/preview` \| visual-identity \| ✅ shipped ([IPI-247](https://linear.app/amo100/issue/IPI-247/design-070-route-agent-map-parity-assets-matching-preview)) \|
\| `/app/onboarding` \| brand-intelligence \| ✅ shipped ([IPI-247](https://linear.app/amo100/issue/IPI-247/design-070-route-agent-map-parity-assets-matching-preview)) \|

---

## Unblocks

[IPI-130](https://linear.app/amo100/issue/IPI-130/aior-014-brand-intelligence-mastra-agent) brand-intelligence agent registration ✅ | Done | 1 | High | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, COPILOTKIT, DASH, IMP, MASTRA |  |  |  |  | 2026-06-15T20:26:51.401Z | 2026-07-10T08:10:47.753Z |  |  | 2026-06-28T00:17:07.559Z |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | 121f06e7-f9da-4571-b9e1-e67ecd5d482e | 21077 | IPI-148, IPI-85, IPI-247, IPI-130, IPI2-180, IPI-110, IPI-50, IPI-136, IPI2-128 |  |  |
...
### Current state (`app/src/mastra/tools/index.ts`) — re-verified 2026-07-10

`agentTools` now exports **20** **tools** (grown from the original shoot-spine 10 via Talent Match/Booking/CRM waves):

* `recommendShootType`, `planDeliverables`, `lookupShotReferences`, `lookupChannelSpecs`, `generateShotListDraft`, `saveApprovedShootDraft`, `approveShotList`, `estimateShootBudget`, `explainShootDnaAlerts`, `discoverSocialChannels`
* `searchTalentByFilters`, `computeTalentMatchScore`, `manageShortlist` (Model Match)
* `searchCompanies`, `searchContacts`, `logActivity`, `moveDealStage` (CRM)
* `checkTalentAvailability`, `draftBookingQuote`, `createBookingDraft` (Booking)

See `app/src/mastra/tools/index.ts` for the current authoritative list.
...
- [X] Verified in [IPI-148](https://linear.app/amo100/issue/IPI-148/shoot-ai-001-ai-agent-that-plans-a-photo-shoot) PR #95 | Done | 5 | High | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | AI, MASTRA |  |  |  |  | 2026-06-14T12:18:17.358Z | 2026-07-10T08:08:45.520Z | 2026-06-22T15:20:59.528Z |  | 2026-06-30T06:35:03.903Z |  |  | 2026-06-29T14:47:04.099Z |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation | Failed | 1e994904-1e89-479b-990b-ffaf19e5163f | 22356 | IPI-132, IPI-181, IPI-166, IPI2-87, IPI2-86, IPI-147, IPI-148, IPI2-129, IPI-47, IPI-48, IPI-137, IPI2-128 |  |  |
| IPI-429 | iPix1 | DOCS-GROQ-MASTRA — Align Mastra Groq Tier Reference with Runtime SSOT | ✅ **Archived** — Completed and merged. Docs fix for Mastra Groq tier reference. No longer actively tracked. | Done | 1 | Medium | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca | ai@socialmediaville.ca | LLM, MASTRA |  |  |  |  | 2026-07-07T00:56:05.038Z | 2026-07-07T21:56:38.553Z | 2026-07-07T00:56:26.286Z |  | 2026-07-07T02:11:34.875Z |  |  |  | IPI-354 | IPIX-INIT-001 — Operator Platform (Q3 2026) |  |  |  | 69c14dcd-6448-46e1-993f-58ebee36e06d | 8003 | IPI-358 |  |  |
...
\| Publish controls \| *from DC* \| *§0 Prove* \| *EmptyState* \|
 | Done |  | Medium | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca | ai@socialmediaville.ca | COPILOTKIT, DESIGN, DESIGNV2, FRONTEND, HTML, MASTRA, QA, UX |  |  |  |  | 2026-06-30T07:04:12.379Z | 2026-07-06T09:51:13.909Z |  |  | 2026-07-06T09:07:01.321Z |  |  |  | IPI-254 | IPIX-INIT-001 — Operator Platform (Q3 2026) | a3b8be45-5b64-4b60-92f2-c733831784b1 | DV2-M3 · Workspace Parity |  | fe624c5e-61cb-4651-8d81-be15333478b7 | 9027 | IPI-422, IPI-338, IPI-258, IPI-246, IPI-247, IPI-191, IPI-188, IPI-262, IPI-172, IPI-257 |  |  |
...
**Unblocks:** IPI-189 MI-03w wizard step-1 specs, IPI-190 lookup test (tests shipped in same PR) | Done |  | No priority | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca | ai@socialmediaville.ca | MASTRA, MEDIA, SHOOT |  |  |  |  | 2026-06-26T08:51:34.148Z | 2026-07-04T06:51:37.515Z | 2026-06-27T06:33:07.558Z |  | 2026-06-27T08:38:25.366Z |  |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | e18ddd58-b7a9-4f7f-976e-3a23d9652472 | 22016 | IPI-190, IPI-189, IPI-185 |  |  |
| IPI-358 | iPix1 | GROQ-004 · Mastra Agents on Groq | ❌ Canceled — Groq removed from roadmap. Mastra agents stay on Gemini for now. Future: route through Cloudflare AI Gateway via @ai-sdk/openai. See 09-intelligence-platform-plan.md. | Canceled | 3 | High | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca | ai@socialmediaville.ca | LLM, MASTRA |  |  |  |  | 2026-07-04T06:17:33.580Z | 2026-07-08T03:39:25.357Z | 2026-07-07T01:14:05.739Z |  |  | 2026-07-07T20:15:46.624Z |  |  | IPI-354 | IPIX-INIT-001 — Operator Platform (Q3 2026) | a07acbf5-d8d3-428b-8834-7bfb28147a76 | GROQ-M2 · Edge ∥ Mastra |  | 8bd22412-eb07-4924-8000-fae51bf8513e | 6918 | IPI-359, IPI-429, IPI-428, IPI-356 |  |  |
| IPI-356 | iPix1 | GROQ-002 · Shared LLM Provider Abstraction | ❌ Canceled — Groq removed from roadmap. REUSE the abstraction design (provider.ts) as base for Cloudflare AI Gateway architecture. The abstraction pattern lives on in the new design. See 09-intelligence-platform-plan.md. | Canceled | 3 | High | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca | ai@socialmediaville.ca | LLM, MASTRA |  |  |  |  | 2026-07-04T06:17:32.687Z | 2026-07-07T20:15:44.906Z | 2026-07-05T23:34:06.752Z |  |  | 2026-07-07T20:15:44.871Z |  |  | IPI-354 | IPIX-INIT-001 — Operator Platform (Q3 2026) | f02f3728-8172-4dad-8cfe-0fd23f21b232 | GROQ-M1 · Infra + Contract |  | c2cef9bb-b880-46df-8d11-8c14b6dfa31d | 6918 | IPI-358, IPI-357, IPI-355, IPI-428 |  |  |
| IPI-354 | iPix1 | GROQ — Gemini → Groq Migration Epic | ❌ Canceled — Groq removed from roadmap per Intelligence Platform Planning Update (2026-07-07). Cloudflare Workers + Gemini is the new primary AI stack. The abstraction design from GROQ-002 should be reused for the Cloudflare AI Gateway architecture. See linear/audit/july-7/09-intelligence-platform-plan.md. | Canceled | 13 | High | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | GEMINI, LLM, MASTRA, SUPA |  |  |  |  | 2026-07-04T06:17:31.990Z | 2026-07-08T03:40:37.266Z | 2026-07-07T02:43:46.418Z |  |  | 2026-07-07T20:15:43.543Z |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | f02f3728-8172-4dad-8cfe-0fd23f21b232 | GROQ-M1 · Infra + Contract |  | 6d6e534e-0757-425b-aca3-45408870b752 | 6918 |  |  |  |
...
`06-model-booking-implementation-plan.md` Phase 4. | Canceled |  | High | 9f12c38f-b20d-492a-ba5b-dd886e8fafef | Model Booking MVP | ai@socialmediaville.ca |  | AI, COPILOTKIT, MASTRA, MODEL, phase:mvp, SUPA |  |  |  |  | 2026-07-01T17:41:26.069Z | 2026-07-10T08:31:26.846Z |  |  |  | 2026-07-10T08:31:17.990Z |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | c39cab39-988b-4acc-a1e0-8e65ff7b5919 | M5 · Launch |  | 7510bc93-02d7-48a8-993c-515b5a6f3345 | 3303 | IPI-312, IPI-347, IPI-307, IPI-309, IPI-410, IPI-397 |  |  |
...
Fetch rewrite · IPI-337 detail tabs · IPI-274 wizard · new AI tools | Canceled |  | High | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca | ai@socialmediaville.ca | COPILOTKIT, DESIGN, DESIGNV2, FRONTEND, HTML, MASTRA, QA, SHOOT, UX |  |  |  |  | 2026-06-30T09:04:27.363Z | 2026-07-04T08:44:37.158Z | 2026-07-03T03:18:24.771Z |  |  | 2026-07-04T08:44:37.142Z |  |  | IPI-254 | IPIX-INIT-001 — Operator Platform (Q3 2026) | a3b8be45-5b64-4b60-92f2-c733831784b1 | DV2-M3 · Workspace Parity |  | f42c06d7-cbd7-41fa-9b43-fbddc3bbc16b | 11930 | IPI-258, IPI-372, IPI-275, IPI-251, IPI-270, IPI-274, IPI-209, IPI-85 |  |  |
| IPI-359 | iPix1 | GROQ-005 · CopilotKit Smoke Verification | ❌ Canceled — Not started, no longer needed. Groq removed from roadmap. See 09-intelligence-platform-plan.md. | Canceled | 1 | Medium | a91ff388-772a-4b0a-b252-0068d6a1297c | AI Platform — LLM Providers | ai@socialmediaville.ca |  | COPILOTKIT, LLM, MASTRA |  |  |  |  | 2026-07-04T06:17:33.903Z | 2026-07-08T03:59:18.264Z |  |  |  | 2026-07-07T20:15:48.564Z |  |  | IPI-354 | IPIX-INIT-001 — Operator Platform (Q3 2026) | 162c5b70-9828-45ea-8c7c-b8e02f160230 | GROQ-M3 · Verify |  | ead3345b-3cff-42b2-b8ef-df97c115c4c8 | 6918 | IPI-360, IPI-428, IPI-358 |  |  |
| IPI-104 | iPix1 | AIOR-005 · Mastra Memory Foundation | Superseded by [IPI-135](https://linear.app/amo100/issue/IPI-135/aior-019-agent-memory-foundation) (AIOR-019 · Agent memory foundation), which ships the unified memory architecture. Canceling to keep the board clean. | Canceled | 3 | Medium | 73be1075-d57b-46ce-bdbe-563b896796af | AI Platform — Agents | ai@socialmediaville.ca |  | AI, MASTRA |  |  |  |  | 2026-06-14T12:18:17.998Z | 2026-07-04T06:51:59.819Z |  |  |  | 2026-06-26T01:36:48.657Z |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | ca3e82a3-edd5-42d9-9001-387c7d786e3d | AGT-M1 · Runtime Foundation |  | b1ca4f36-85aa-4953-be7b-ce274f17920b | 23877 | IPI-109, IPI-48, IPI-135, IPI2-128 |  |  |
...
IPI-274 can proceed with WizardStep chrome for existing 6-step flow. | Canceled |  | Low | 1adb08a8-6c36-4bc9-8b47-2c9ffb827a89 | DESIGN V2 — Operator React Parity | ai@socialmediaville.ca |  | COPILOTKIT, DESIGN, DESIGNV2, MASTRA, SHOOT, SUPA, UX |  |  |  |  | 2026-06-30T06:08:46.765Z | 2026-07-06T09:05:23.899Z |  |  |  | 2026-07-06T09:05:23.878Z |  |  |  | IPIX-INIT-001 — Operator Platform (Q3 2026) | 753a263e-9dab-4704-8281-f0f2fde70a9a | DV2-M4 · Production Verified |  | 9395b747-7a54-450a-aa8b-49464aebe606 | 9029 | IPI-274 |  |  |
