...
**Note (2026-07-13):** check `006-CF-WORKER-add-binding-via-dashboard.md` first — it claims this same binding is already added, via the dashboard instead of this file's CLI method. Verify which actually happened (check `app/wrangler.jsonc` for the live `ai` binding block) before redoing this.
