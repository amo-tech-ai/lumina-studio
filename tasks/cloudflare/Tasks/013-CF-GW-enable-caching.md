...
**Note (2026-07-13):** this duplicated `archive/31-CF-GATEWAY-enable-caching.md` (same objective, different numbering pass). This file is the canonical one — archived the other rather than deleting it.
