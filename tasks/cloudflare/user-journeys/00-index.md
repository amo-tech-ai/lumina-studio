...
**Do not claim Production Verified** for any journey until **IPI-472 · INFRA-001 — Cloudflare Worker Deployment Pipeline** lands remote smoke.
...
| J02 | [**IPI-502 · CF-UJ-002**](https://linear.app/amo100/issue/IPI-502) | [02-brand-intelligence.md](./02-brand-intelligence.md) | Crawl + BI panel demoable; **re-run after IPI-455** | 🟡 | P0 |
...
| J04 | [**IPI-504 · CF-UJ-004**](https://linear.app/amo100/issue/IPI-504) | [04-shoot-planning.md](./04-shoot-planning.md) | `production-planner` shoot draft→approve ships | 🟡 | P1 |
...
| J09 | [**IPI-509 · CF-UJ-009**](https://linear.app/amo100/issue/IPI-509) | [09-embeddings-asset-search.md](./09-embeddings-asset-search.md) | **Now** (contracts); search UI after **IPI-474**; remote after **IPI-472** | 🟢 local | P0 |
...
| J11 | [**IPI-510 · CF-UJ-011**](https://linear.app/amo100/issue/IPI-510) | [11-ai-gateway-health.md](./11-ai-gateway-health.md) | **Continuous** — every AI/Worker PR + before demos | 🟢 local | P0 |
...
| Blocker | Impact |
|---------|--------|
| No remote Worker deploy (**IPI-472 · INFRA-001**) | No Remote Preview / Production Verified |
...
| Chat error envelope incomplete | **IPI-495 · CF-AI-004e** |
| AC-J E2E mostly unchecked | **IPI-454 · CF-AI-001** still In Review |
...
| Adapter vitest | 🟢 |
| `resolveModel` gateway unit (#317) | 🟡 (PR open) |
| Playwright journey packs | ⚪ |
| Wrangler live curls | 🟢 (health/embed/chat) |
| Browser CopilotKit under gateway | ⚪ / 🟡 stand-in only |
| Supabase RLS journey asserts | 🟡 (CI web015; not journey-tied) |

**Overall real-world readiness (product AI journeys hitting CF as designed): ~42%**  
(Local gateway+embed strong; Mastra default path still direct; no prod Worker; no browser gateway proof.)
