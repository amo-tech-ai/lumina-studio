...
| 391 | [IPI-391](https://linear.app/amo100/issue/IPI-391) | RF-04a Company Detail page | SCR-27 | 🟡 In Progress — real build needed: `getCompany(id)`, 4 tabs. **Consumes** shared `ActivityTimeline` (see Wave 1 below), does not build it | 388 (done), 385 (done) · dup IPI-393 resolved (Duplicate, parented here) |
