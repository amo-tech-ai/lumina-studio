...
**Companion notes:** [`notes-1.md`](./notes-1.md) · [`notes-2.md`](./notes-2.md) · [`notes-3.md`](./notes-3.md) · [`notes-4.md`](./notes-4.md) · [`todo`](./todo) · [`j17-plan.md`](./j17-plan.md) · [`testing.md`](./testing.md) · [`links.md`](./links.md)  
**Evidence date:** 2026-07-18 · Linear + MCP advisors + `migration list --linked` + GH Actions on `origin/main`  
**Audit:** [`j18-supa-audit.md`](../audit/j18-supa-audit.md)  
