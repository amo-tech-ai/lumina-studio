...
2. **AI-first, human-approved (HITL).** AI drafts; the human reviews and approves. Wizards arrive pre-filled. AI never writes without a visible Approve / Edit / Reject path.
