...
> Generated: 2026-07-13 | Total: ~260 document files
...
## `tests/` — Test Reference (2 docs + 1 TS spec)
...
| `plan/` | 27 | Planning, audits, planner design prompts |
| `planner/` | 28 | Planner feature design, QA, tasks |
| `prompts/` | 1 | AI generation prompts |
| `screenshots/` | 1 | Screenshot index |
| `tasks/` | 78 | Master backlog, refactor tasks, per-screen tasks, wireframes |
| `tests/` | 2 | Test reference copies |
| `uploads/` | 38 | Uploaded design references |
| **Total** | **~260** | |
