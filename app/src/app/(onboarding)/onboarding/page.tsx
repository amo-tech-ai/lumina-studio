 ...
 *
 * IPI-835 · B1 wires a real onboarding_sessions draft (localStorage idempotency +
 * autosave). Crawl/Realtime (Slice C) and approval (Slice D) come next.
 * Legacy /app/onboarding stays until Slice E after IPI-836.
 *
