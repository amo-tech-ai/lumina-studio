# Cloudflare Agents SDK — entry guide

Load this when building stateful AI agents, chat apps, MCP servers, workflows, or WebSocket agents on Workers.
For product-level routing, start from the hub [`SKILL.md`](../../SKILL.md).
...
### Core
- **[state-scheduling.md](state-scheduling.md)** — State persistence, scheduling, SQL
- **[callable.md](callable.md)** — RPC methods, streaming, timeouts
- **[routing.md](routing.md)** — URL patterns, custom routing, `getAgentByName`
- **[configuration.md](configuration.md)** — Wrangler config, bindings, Vite setup

### Chat & Streaming
- **[streaming-chat.md](streaming-chat.md)** — AIChatAgent, resumable streams, tools
- **[client-sdk.md](client-sdk.md)** — `useAgent`, `useAgentChat`, `AgentClient`
- **[server-driven-messages.md](server-driven-messages.md)** — Trigger patterns, `saveMessages`
- **[human-in-the-loop.md](human-in-the-loop.md)** — Approval flows, `needsApproval`

### Background Processing
- **[workflows.md](workflows.md)** — Durable Workflows integration
- **[durable-execution.md](durable-execution.md)** — `runFiber`, `stash`, surviving eviction
- **[queue-retries.md](queue-retries.md)** — Built-in queue, retry with backoff

### Integrations
- **[mcp.md](mcp.md)** — MCP client and server, transports, securing
- **[email.md](email.md)** — Email routing and handling
- **[webhooks-push.md](webhooks-push.md)** — Webhooks, push notifications
- **[observability.md](observability.md)** — Diagnostics-channel events

### Experimental
- **[think.md](think.md)** — `@cloudflare/think` higher-level chat agent
- **[voice.md](voice.md)** — `@cloudflare/voice` STT/TTS
- **[codemode.md](codemode.md)** — Code Mode for tool orchestration
- **[browse-the-web.md](browse-the-web.md)** — CDP browser tools
