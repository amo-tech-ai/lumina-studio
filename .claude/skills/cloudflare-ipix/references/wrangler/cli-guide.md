# Wrangler CLI — full command reference

Load before running `wrangler` deploy/dev/secret commands. For binding config patterns see [configuration.md](./configuration.md).
