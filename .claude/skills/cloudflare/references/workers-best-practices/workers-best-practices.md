# Workers best practices — entry guide

Load when writing or reviewing Worker code, `wrangler.jsonc`, bindings, streaming, or anti-patterns.
...
- **Durable Objects**: load [`references/durable-objects/`](../durable-objects/)
- **Workflows**: see [Rules of Workflows](https://developers.cloudflare.com/workflows/build/rules-of-workflows/)
- **Wrangler CLI commands**: load [`references/wrangler/cli-guide.md`](../wrangler/cli-guide.md)
