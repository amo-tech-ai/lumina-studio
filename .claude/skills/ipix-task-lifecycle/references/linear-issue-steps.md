...
Use when creating or updating **any executable** issue on [linear.app/ipix](https://linear.app/ipix) (team **IPI**). Pair with **`ipix-task-lifecycle`** and **`mermaid-diagrams`**.
