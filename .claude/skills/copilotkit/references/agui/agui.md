...
- For CopilotKit React hooks and frontend components, use [`develop/develop.md`](../develop/develop.md)
- For CopilotKit runtime setup and configuration, use [`setup/setup.md`](../setup/setup.md)
- For framework-specific integration guides (LangGraph, Mastra, CrewAI), use [`integrations/integrations.md`](../integrations/integrations.md)
