...
| Next.js (proxy, routing, caching, Turbopack) | [`nextjs-16`](../nextjs-16/SKILL.md) — load first, repo runs Next 16 | |
| Next.js (general App Router patterns) | [`nextjs-best-practices`](../nextjs-best-practices/SKILL.md) | |
