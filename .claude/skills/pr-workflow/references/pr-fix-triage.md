...
| `app/src/lib/supabase/**`, auth, onboarding, `proxy.ts` | `ipix-supabase`, `nextjs-supabase-auth` | Supabase MCP |
| App Router pages/layouts (non-auth) | `nextjs-best-practices` | Next.js DevTools MCP (`cd app && npm run dev` first) |
