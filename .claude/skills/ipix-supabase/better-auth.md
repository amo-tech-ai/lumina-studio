...
description: "Use when working on auth, identity, or RLS in iPix. Triggers: 'account_type', 'user_metadata', 'app_metadata', 'JWT claim', 'RLS policy', 'sign-in', 'OAuth', 'signed token', 'magic link', 'session'. Built on better-auth-best-practices (skills.sh) + the Supabase-specific gotchas we hit in D2/D5."
metadata:
  source: https://skills.sh/ (better-auth-best-practices)
  installed: 2026-04-29
  version: "0.1.0"
  origin: external + iPix Supabase-Auth adaptations
---

# Auth best practices — iPix (Supabase Auth)
