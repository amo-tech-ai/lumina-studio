---
name: edge-functions-dependencies
description: Managing npm/esm.sh/deno.land packages in Edge Functions — import maps, vendoring, lock files. Use when adding or updating a dependency in a Deno function.
version: 1.0.0
---
