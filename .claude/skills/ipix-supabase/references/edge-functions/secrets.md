...
description: Secrets and environment variables in Edge Functions — default secrets, supabase secrets set/list, deploy-with-env. Use when adding API keys or sensitive config to a function.
version: 1.0.0
---
