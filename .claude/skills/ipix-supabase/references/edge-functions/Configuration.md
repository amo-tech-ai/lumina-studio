---
name: edge-functions-configuration
description: Per-function config in config.toml — JWT verification toggle, import maps, deploy options. Use when a function needs different auth or dependency settings from the default.
version: 1.0.0
---
