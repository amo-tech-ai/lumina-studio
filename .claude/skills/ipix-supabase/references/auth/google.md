---
name: auth-google
description: Google Sign-In for Supabase — Google Cloud OAuth client setup, authorized JS origins + redirect URIs, signInWithOAuth({ provider:"google" }) for web, One Tap pattern for Next.js, saving provider_refresh_token. Covers web, React Native, Flutter, Swift, Kotlin, Chrome extensions.
topics: [auth, oauth, social-login, google, one-tap]
applies_to: [src/pages/Login.tsx, app/src/app/api/copilotkit]
stack: web, nextjs
source: https://supabase.com/docs/guides/auth/social-login/auth-google
ipix_status: implemented — Login.tsx uses signInWithOAuth provider:google, redirectTo:/app. Supabase dashboard + Google Cloud Console config required (see Login.tsx commit).
ipix_callback_url: https://nvdlhrodvevgwdsneplk.supabase.co/auth/v1/callback
ipix_redirect_urls: [https://www.ipix.co/**, http://localhost:8080/**]
---
