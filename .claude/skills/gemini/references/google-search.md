---
parent: gemini
title: Google Search Grounding (Interactions API)
description: Interactions API variant of Google Search grounding — beta notes vs generateContent for production.
load_when: interactions API, googleSearch beta, groundingMetadata
tags: gemini, google-search, grounding, interactions-api
---
