...
description: Grounding with Google Maps via Interactions API — location-aware responses and beta vs generateContent guidance.
load_when: googleMaps, maps grounding, location queries, places
tags: gemini, maps, grounding, interactions-api
---
