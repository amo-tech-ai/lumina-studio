...
parent: gemini
title: Live API
description: Preview real-time voice and vision streaming — low-latency bidirectional sessions with Gemini.
load_when: live API, voice agent, real-time audio, streaming vision
tags: gemini, live-api, voice, streaming, preview
---
