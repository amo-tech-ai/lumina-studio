...
description: Function calling, Google Search, and combined tools inside Live API real-time sessions.
load_when: live API tools, real-time function calling, live googleSearch
tags: gemini, live-api, tools, function-calling
---
