---
parent: gemini
title: Combine Built-in Tools
description: Mix built-in tools with function calling — tool context circulation and multi-tool generateContent configs.
load_when: multiple tools, tool combination, built-in plus custom tools
tags: gemini, tools, function-calling, tool-combination
---
