...
description: Implicit and explicit context caching — token minimums, TTL, cost savings, and cache management.
load_when: context cache, cachedContent, token savings, repeated prompts
tags: gemini, caching, cost-optimization, tokens
---
