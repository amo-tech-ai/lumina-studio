...
parent: gemini
title: Webhooks
description: Push notifications for Batch and LRO completion — Standard Webhooks verification and endpoint setup.
load_when: webhooks, batch job notifications, LRO callbacks, standard-webhooks
tags: gemini, webhooks, batch-api, async
---
