...
description: Function declarations, execution loop, parallel and compositional calling, modes, and thought signatures.
load_when: functionDeclarations, functionCall, tools, external APIs, Deno edge functions
tags: gemini, function-calling, tools, agents
---
