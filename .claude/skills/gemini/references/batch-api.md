...
parent: gemini
title: Batch API
description: Asynchronous bulk generateContent at 50% cost — inline vs file input, job lifecycle, and structured output in batches.
load_when: batch API, bulk inference, async jobs, large-scale evaluation
tags: gemini, batch-api, async, cost-optimization
---
