---
parent: gemini
title: Structured Output (Full Reference)
description: Extended structured output guide — Pydantic/Zod schemas, recursive structures, moderation, and SDK patterns.
load_when: responseSchema, JSON schema, pydantic, zod, type-safe extraction
tags: gemini, structured-output, json-schema, pydantic, zod
---
