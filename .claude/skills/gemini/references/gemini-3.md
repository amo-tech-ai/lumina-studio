...
description: Gemini 3 Pro, Flash, and Pro-Image models — thinking levels, media resolution, temperature defaults, and migration from Gemini 2.5.
load_when: gemini-3-pro-preview, gemini-3-flash-preview, thinkingLevel, media_resolution, Deno generateContent
tags: gemini, gemini-3, models, multimodal
---
