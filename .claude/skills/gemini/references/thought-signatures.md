...
description: Preserve reasoning context across turns — REST/manual handling vs SDK automatic management.
load_when: thoughtSignature, multi-turn function calling, image editing, REST API history
tags: gemini, thought-signatures, gemini-3, multi-turn
---
