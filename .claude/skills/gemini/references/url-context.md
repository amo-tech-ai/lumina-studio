---
parent: gemini
title: URL Context (Full Reference)
description: Extended URL context docs — two-step retrieval, metadata, limits, and combining with Search.
load_when: urlContext metadata, URL_RETRIEVAL_STATUS, multi-URL analysis
tags: gemini, url-context, tools, grounding
---
