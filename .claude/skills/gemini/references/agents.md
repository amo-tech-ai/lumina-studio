---
parent: gemini
title: Managed Agents Overview
description: Gemini API managed agents — Antigravity sandbox, custom agents, and AI Studio prototyping.
load_when: managed agents, antigravity, autonomous agent, sandbox
tags: gemini, agents, antigravity, sandbox
---
