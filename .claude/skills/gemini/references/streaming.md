...
description: Server-sent events streaming for Interactions API — incremental responses and stream handling patterns.
load_when: stream true, SSE, streaming responses, interactions API
tags: gemini, streaming, interactions-api, sse
---
