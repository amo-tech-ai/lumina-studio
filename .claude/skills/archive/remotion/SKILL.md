...
### Additional topics (merged from remotion-best-practices)
- **[references/subtitles.md](references/subtitles.md)** - Subtitle workflows
- **[references/transparent-videos.md](references/transparent-videos.md)** - Rendering videos with alpha/transparency
- **[references/light-leaks.md](references/light-leaks.md)** - Light-leak overlay effects
- **[references/maps.md](references/maps.md)** - Animated maps
- **[references/parameters.md](references/parameters.md)** - Parameterizing compositions
