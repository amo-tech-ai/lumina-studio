...
|---|-----|-------------|-----------|
| 1 | [Development Standards](./01-development-standards.md) | First — how agents are steered | Alone (foundation) |
| 2 | [Task Template](./02-task-template.md) | Before rewriting Linear issues | After #1 |
