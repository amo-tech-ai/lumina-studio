...
- `app/src/components/web/header.tsx`
- `app/src/components/web/footer.tsx`
- `app/src/components/web/animated-section.tsx`
- `app/src/components/web/faq.tsx`

**Scope:**
- Create `(web)` route group with dedicated layout (no CopilotKit/OperatorPanel)
- Move operator routes to `(app)` route group with CopilotKit layout
...
- Update `docs/website/marketing-next-plan.md` with any changes
